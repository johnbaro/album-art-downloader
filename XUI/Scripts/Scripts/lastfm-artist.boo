...
class LastFmArtist(AlbumArtDownloader.Scripts.IScript):
	...
	def Search(artist as string, album as string, results as IScriptResults):
		...
		for imageIdMatch as Match in imageIdMatches:
			...
			results.Add("http://userserve-ak.last.fm/serve/160/${id}.jpg", artist, "http://www.last.fm/music/${encodedArtist}/+images/${id}", -1, -1, "http://userserve-ak.last.fm/serve/_/${id}.jpg");
