...
class ArkivMusik(AlbumArtDownloader.Scripts.IScript):
	...
	def Search(artist as string, album as string, results as IScriptResults):
		...
		searchResultsHtml as string = GetPage("http://www.arkivmusic.com/classical/NameList?searching=1&searchingPage=ABC&role_wanted=0&search_term=" + EncodeUrl(artist + " " + album))
